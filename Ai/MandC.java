...
/*
satish@satish-PC:~/Desktop/GROUP-B/asg-6-3-canibal-3-missionaries$ javac MandC.java 
Note: MandC.java uses unchecked or unsafe operations.
Note: Recompile with -Xlint:unchecked for details.
satish@satish-PC:~/Desktop/GROUP-B/asg-6-3-canibal-3-missionaries$ java MandC 

The solution is:

   0. Initial state ---> (3 3 L 0 0)
   1. Two cannibals cross left to right. ---> (3 1 R 0 2)
   2. One cannibal crosses right to left. ---> (3 2 L 0 1)
   3. Two cannibals cross left to right. ---> (3 0 R 0 3)
   4. One cannibal crosses right to left. ---> (3 1 L 0 2)
   5. Two missionaries cross left to right. ---> (1 1 R 2 2)
   6. One missionary and one cannibal cross right to left. ---> (2 2 L 1 1)
   7. Two missionaries cross left to right. ---> (0 2 R 3 1)
   8. One cannibal crosses right to left. ---> (0 3 L 3 0)
   9. Two cannibals cross left to right. ---> (0 1 R 3 2)
   10. One missionary crosses right to left. ---> (1 1 L 2 2)
   11. One missionary and one cannibal cross left to right. ---> (0 0 R 3 3)
